...
let githubProfileContainer = document.getElementById("github-profile-container")

let usernameValue = document.getElementById("username")
let submitBtn = document.getElementById("submit")

spinner.classList.toggle('hide')
githubProfileContainer.classList.toggle('hide')
  ...
  fetch("https://api.github.com/graphql", requestOptions)
    ...
    .then((result) => {
      ...
      document.getElementById("repo-count").innerHTML =
        result.data.user.repositories.nodes.length;
      ...
      document.getElementById("profile-bio").innerHTML = result.data.user.bio;
...
function onSubmit(event) {
  ...
  console.log('user :>> ', usernameValue.value.trim());
  getRepoPubKey(usernameValue.value.trim());
}
